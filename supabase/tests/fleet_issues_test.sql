...
select throws_ok($$select public.complete_pickup((select id from public.pickup_checklists where agreement_id='64000000-0000-4000-8000-000000000002'),2000,now(),true)$$,'P0001','vehicle has an unresolved blocking issue','blocking issue prevents pickup completion');
...
select lives_ok($$select public.complete_pickup((select id from public.pickup_checklists where agreement_id='64000000-0000-4000-8000-000000000002'),2000,now(),true)$$,'pickup completes after blocker resolution');
