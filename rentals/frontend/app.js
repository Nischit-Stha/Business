...
function syncRentalsFromBookingRequestsCache() {
    ...
    rentals = bookingRequestsCache
        ...
        .map(request => ({
            ...
            email: request.email || '',
            customerId: Number(request.customerId || request.customer_id || 0) || null,
...
function mapSupabaseBookingRequestToLocal(request) {
    return {
        ...
        customerId: Number(request.customer_id || request.customerId || 0) || null,
...
function mapSupabaseInvoiceToLocal(invoice) {
    ...
    return {
        ...
        customerId: Number(invoice.customer_id || invoice.customerId || 0) || null,
...
function mapLocalInvoiceToSupabase(invoice) {
    ...
    return {
        ...
        customer_id: Number(invoice.customerId || invoice.customer_id || 0) || null,
...
function mapLocalOfferToSupabase(offer) {
    return {
        id: Number(offer.id),
        customer_id: Number(offer.customerId || offer.customer_id || 0) || null,
...
function mapLocalBookingRequestToSupabase(request) {
    return {
        ...
        customer_id: Number(request.customerId || request.customer_id || 0) || null,
...
function generateInvoiceFromRental(rentalId) {
    ...
    const newInvoice = {
        ...
        customerId: Number(rental.customerId || rental.customer_id || 0) || null,
